...
return'';}
LW.fhs=function(){var ns=['post-body'];var exclude=['format_teaser','sideContent','ngg-widget'];var es;var divs=document.getElementsByTagName('div');es=LW.fesbc(divs,'linkwithin_div');if(es.length>0)return es;if(window['linkwithin_div_class']){es=LW.fesbc(divs,window['linkwithin_div_class']);return es;}
...
if(ns[i]==''){es=LW.f(function(e){return!/entry-type-page/.test(e.parentNode.className)},es);return es;}
