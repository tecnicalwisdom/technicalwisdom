...
return'';}
LW.fhs=function(){var ns=['post-body','article-content','entry-contentt','entry','post-entry','post-inner','postmeta2','post_content','text','postcontent','single','post-header','content','post','art-PostContent'];var exclude=['format_teaser','sideContent','ngg-widget'];var es;var divs=document.getElementsByTagName('div');es=LW.fesbc(divs,'linkwithin_div');if(es.length>0)return es;if(window['linkwithin_div_class']){es=LW.fesbc(divs,window['linkwithin_div_class']);return es;}
